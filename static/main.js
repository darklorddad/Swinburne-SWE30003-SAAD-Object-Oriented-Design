...
function renderParks(parks) {
  ...
  const parksHtml = parks
    .map(
      (park, index) => `
      <div class="group flex flex-col h-full bg-zinc-900/80 backdrop-blur-sm rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-black/50">
