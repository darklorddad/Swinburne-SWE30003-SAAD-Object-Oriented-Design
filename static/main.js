  ...
  try {
    ...
    const parksHtml = parksWithDetails
      .map((park) => {
        ...
        return `
        <div class="mb-4 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden">
            <div class="p-4 flex justify-between items-center cursor-pointer hover:bg-white/5 transition-colors" data-bs-toggle="collapse" data-bs-target="#collapse-${park.id}" aria-expanded="false">
